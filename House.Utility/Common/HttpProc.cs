...
namespace FangChan.Common
{
    ...
    public class WebClient
    {
        ...
        {
            HttpWebRequest request = CreateRequest(url, "GET");
            request.UserAgent = "Mozilla/4.0 (compatible; MSIE 7.0; Windows NT 5.1; Trident/4.0; Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.1; SV1) ; 360SE)";
